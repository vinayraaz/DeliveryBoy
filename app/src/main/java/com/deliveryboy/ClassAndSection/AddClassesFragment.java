...
public class AddClassesFragment extends Fragment implements View.OnClickListener {
   ...
   // ArrayList<String> newClassList;
    ...
    private void getClassSectionList(JSONObject jsonObject) {
        Log.i("CLASS_SECTION", "" + Constant.SCHOOL_ID);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.button_added:
                ...
                //System.out.println("divisionClassModels***"+divisionClassModels.size());
               // System.out.println("divisionClassModels***"+gson.toJson(divisionClassModels));
